...
define("@scom/oswap-cross-chain-bridge-contract/contracts/Authorization.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-cross-chain-bridge-contract/contracts/Authorization.json.ts"], function (require, exports, eth_contract_1, Authorization_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("@scom/oswap-cross-chain-bridge-contract/contracts/MOCK_TrollRegistry.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-cross-chain-bridge-contract/contracts/MOCK_TrollRegistry.json.ts"], function (require, exports, eth_contract_2, MOCK_TrollRegistry_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.MOCK_TrollRegistry = void 0;
    class MOCK_TrollRegistry extends eth_contract_2.Contract {
        constructor(wallet, address) {
        ...
        decodeAddTrollEvent(event) {
            ...
            return {
                troll: result.troll,
                trollProfileIndex: new eth_contract_2.BigNumber(result.trollProfileIndex),
        ...
        decodeUnlockSuperTrollEvent(event) {
            ...
            return {
                ...
                penalty: new eth_contract_2.BigNumber(result.penalty),
                _event: event
            };
        }
        ...
        assign() {
            ...
            let trollProfiles_call = async (param1, options) => {
                ...
                return {
                    troll: result.troll,
                    trollType: new eth_contract_2.BigNumber(result.trollType)
                };
            };
...
define("@scom/oswap-cross-chain-bridge-contract/contracts/MintableToken.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-cross-chain-bridge-contract/contracts/MintableToken.json.ts"], function (require, exports, eth_contract_3, MintableToken_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.MintableToken = void 0;
    class MintableToken extends eth_contract_3.Contract {
        constructor(wallet, address) {
...
define("@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_BridgeVaultTrollRegistry.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_BridgeVaultTrollRegistry.json.ts"], function (require, exports, eth_contract_4, OSWAP_BridgeVaultTrollRegistry_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.OSWAP_BridgeVaultTrollRegistry = void 0;
    class OSWAP_BridgeVaultTrollRegistry extends eth_contract_4.Contract {
        constructor(wallet, address) {
        ...
        decodePenaltyEvent(event) {
            let result = event.data;
            return {
                trollProfileIndex: new eth_contract_4.BigNumber(result.trollProfileIndex),
        ...
        decodeStakeEvent(event) {
            ...
            return {
                ...
                trollProfileIndex: new eth_contract_4.BigNumber(result.trollProfileIndex),
                amount: new eth_contract_4.BigNumber(result.amount),
                shares: new eth_contract_4.BigNumber(result.shares),
                backerBalance: new eth_contract_4.BigNumber(result.backerBalance),
                trollBalance: new eth_contract_4.BigNumber(result.trollBalance),
                totalShares: new eth_contract_4.BigNumber(result.totalShares),
                _event: event
            };
        }
        ...
        decodeUnstakeEvent(event) {
            ...
            return {
                ...
                amount: new eth_contract_4.BigNumber(result.amount),
                shares: new eth_contract_4.BigNumber(result.shares),
                approvalDecrement: new eth_contract_4.BigNumber(result.approvalDecrement),
                trollBalance: new eth_contract_4.BigNumber(result.trollBalance),
                totalShares: new eth_contract_4.BigNumber(result.totalShares),
                _event: event
            };
        ...
        decodeUnstakeApprovalEvent(event) {
            ...
            return {
                ...
                signers: result.signers.map(e => new eth_contract_4.BigNumber(e)),
                shares: new eth_contract_4.BigNumber(result.shares),
                _event: event
            };
        }
        ...
        assign() {
            let backerStakes_call = async (param1, options) => {
                ...
                return {
                    trollProfileIndex: new eth_contract_4.BigNumber(result.trollProfileIndex),
                    shares: new eth_contract_4.BigNumber(result.shares),
                    pendingWithdrawal: new eth_contract_4.BigNumber(result.pendingWithdrawal),
                    approvedWithdrawal: new eth_contract_4.BigNumber(result.approvedWithdrawal)
                };
            };
            ...
            let verifyStakedValue_call = async (params, options) => {
                ...
                return {
                    superTrollCount: new eth_contract_4.BigNumber(result.superTrollCount),
                    totalStake: new eth_contract_4.BigNumber(result.totalStake),
                    signers: result.signers.map(e => new eth_contract_4.BigNumber(e))
                };
            };
...
define("@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_ChainRegistry.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_ChainRegistry.json.ts"], function (require, exports, eth_contract_5, OSWAP_ChainRegistry_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.OSWAP_ChainRegistry = void 0;
    class OSWAP_ChainRegistry extends eth_contract_5.Contract {
        constructor(wallet, address) {
        ...
        decodeNewChainEvent(event) {
            let result = event.data;
            return {
                chainId: new eth_contract_5.BigNumber(result.chainId),
        ...
        decodeUpdateVaultEvent(event) {
            let result = event.data;
            return {
                index: new eth_contract_5.BigNumber(result.index),
                chainId: new eth_contract_5.BigNumber(result.chainId),
                vault: {
        ...
        assign() {
            ...
            let getChain_call = async (params, options) => {
                ...
                return {
                    status: new eth_contract_5.BigNumber(result._status),
...
define("@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_ChainRegistryExecutor.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_ChainRegistryExecutor.json.ts"], function (require, exports, eth_contract_6, OSWAP_ChainRegistryExecutor_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.OSWAP_ChainRegistryExecutor = void 0;
    class OSWAP_ChainRegistryExecutor extends eth_contract_6.Contract {
        constructor(wallet, address) {
...
define("@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_ConfigStore.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_ConfigStore.json.ts"], function (require, exports, eth_contract_7, OSWAP_ConfigStore_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.OSWAP_ConfigStore = void 0;
    class OSWAP_ConfigStore extends eth_contract_7.Contract {
        constructor(wallet, address) {
        ...
        assign() {
            ...
            let getBridgeParams_call = async (asset, options) => {
                ...
                return {
                    ...
                    param3: result[2],
                    param4: result[3],
                    param5: new eth_contract_7.BigNumber(result[4]),
                    param6: new eth_contract_7.BigNumber(result[5])
                };
            };
            ...
            let getSignatureVerificationParams_call = async (options) => {
                ...
                return {
                    param1: new eth_contract_7.BigNumber(result[0]),
                    param2: new eth_contract_7.BigNumber(result[1]),
...
define("@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_ConfigStoreTradeVault.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_ConfigStoreTradeVault.json.ts"], function (require, exports, eth_contract_8, OSWAP_ConfigStoreTradeVault_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.OSWAP_ConfigStoreTradeVault = void 0;
    class OSWAP_ConfigStoreTradeVault extends eth_contract_8.Contract {
        constructor(wallet, address) {
        ...
        assign() {
            ...
            let getTradeParam_call = async (options) => {
                ...
                return {
                    param1: result[0],
                    param2: new eth_contract_8.BigNumber(result[1])
                };
            };
...
define("@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_ContractProxy.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_ContractProxy.json.ts"], function (require, exports, eth_contract_9, OSWAP_ContractProxy_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.OSWAP_ContractProxy = void 0;
    class OSWAP_ContractProxy extends eth_contract_9.Contract {
        constructor(wallet, address) {
...
define("@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_MainChainTrollRegistry.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_MainChainTrollRegistry.json.ts"], function (require, exports, eth_contract_10, OSWAP_MainChainTrollRegistry_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.OSWAP_MainChainTrollRegistry = void 0;
    class OSWAP_MainChainTrollRegistry extends eth_contract_10.Contract {
        constructor(wallet, address) {
        ...
        decodeAddTrollEvent(event) {
            ...
            return {
                owner: result.owner,
                troll: result.troll,
                trollProfileIndex: new eth_contract_10.BigNumber(result.trollProfileIndex),
                isSuperTroll: result.isSuperTroll,
                _event: event
            };
        }
        ...
        decodeBlockNftTokenIdEvent(event) {
            ...
            return {
                nft: result.nft,
                tokenId: new eth_contract_10.BigNumber(result.tokenId),
        ...
        decodeStakeGeneralTrollEvent(event) {
            ...
            return {
                ...
                nft: result.nft,
                tokenId: new eth_contract_10.BigNumber(result.tokenId),
                stakesChange: new eth_contract_10.BigNumber(result.stakesChange),
                stakesBalance: new eth_contract_10.BigNumber(result.stakesBalance),
                _event: event
            };
        }
        ...
        decodeUpdateNFTEvent(event) {
            ...
            return {
                nft: result.nft,
                trollType: new eth_contract_10.BigNumber(result.trollType),
                _event: event
            };
        }
        parseUpdateTrollEvent(receipt) {
        ...
        assign() {
            ...
            let backerStaking_call = async (params, options) => {
                ...
                return (result.map(e => ({
                    nft: e.nft,
                    tokenId: new eth_contract_10.BigNumber(e.tokenId),
                    trollProfileIndex: new eth_contract_10.BigNumber(e.trollProfileIndex),
                    timestamp: new eth_contract_10.BigNumber(e.timestamp)
                })));
            };
            ...
            let getTrollProperties_call = async (trollProfileIndex, options) => {
                ...
                return {
                    troll: {
                        ...
                        trollType: new eth_contract_10.BigNumber(result.troll.trollType),
                        nftCount: new eth_contract_10.BigNumber(result.troll.nftCount)
                    },
            ...
            let getTrolls_call = async (params, options) => {
                ...
                return (result.map(e => ({
                    owner: e.owner,
                    troll: e.troll,
                    trollType: new eth_contract_10.BigNumber(e.trollType),
                    nftCount: new eth_contract_10.BigNumber(e.nftCount)
                })));
            };
            ...
            let stakeTo_call = async (params, options) => {
                ...
                return {
                    ...
                    tokenId: new eth_contract_10.BigNumber(result.tokenId),
                    trollProfileIndex: new eth_contract_10.BigNumber(result.trollProfileIndex),
                    timestamp: new eth_contract_10.BigNumber(result.timestamp)
                };
            };
            ...
            let stakeToInv_call = async (params, options) => {
                ...
                return {
                    backer: result.backer,
                    index: new eth_contract_10.BigNumber(result.index)
                };
            };
            ...
            let trollProfiles_call = async (param1, options) => {
                ...
                return {
                    ...
                    troll: result.troll,
                    trollType: new eth_contract_10.BigNumber(result.trollType),
                    nftCount: new eth_contract_10.BigNumber(result.nftCount)
                };
            };
            this.trollProfiles = trollProfiles_call;
...
define("@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_MainChainVotingExecutor.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_MainChainVotingExecutor.json.ts"], function (require, exports, eth_contract_11, OSWAP_MainChainVotingExecutor_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.OSWAP_MainChainVotingExecutor = void 0;
    class OSWAP_MainChainVotingExecutor extends eth_contract_11.Contract {
        constructor(wallet, address) {
...
define("@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_RouterVaultWrapper.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_RouterVaultWrapper.json.ts"], function (require, exports, eth_contract_12, OSWAP_RouterVaultWrapper_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.OSWAP_RouterVaultWrapper = void 0;
    class OSWAP_RouterVaultWrapper extends eth_contract_12.Contract {
        constructor(wallet, address) {
        ...
        decodeSwapEvent(event) {
            ...
            return {
                vault: result.vault,
                orderId: new eth_contract_12.BigNumber(result.orderId),
                sender: result.sender,
                inToken: result.inToken,
                inAmount: new eth_contract_12.BigNumber(result.inAmount),
                _event: event
            };
        }
        parseUpdateConfigStoreEvent(receipt) {
...
define("@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_SideChainTrollRegistry.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_SideChainTrollRegistry.json.ts"], function (require, exports, eth_contract_13, OSWAP_SideChainTrollRegistry_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.OSWAP_SideChainTrollRegistry = void 0;
    class OSWAP_SideChainTrollRegistry extends eth_contract_13.Contract {
        constructor(wallet, address) {
        ...
        decodeUnlockSuperTrollEvent(event) {
            ...
            return {
                ...
                unlock: result.unlock,
                bridgeVault: result.bridgeVault,
                penalty: new eth_contract_13.BigNumber(result.penalty),
                _event: event
            };
        }
        parseUpdateConfigStoreEvent(receipt) {
...
define("@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_SideChainVotingExecutor.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_SideChainVotingExecutor.json.ts"], function (require, exports, eth_contract_14, OSWAP_SideChainVotingExecutor_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.OSWAP_SideChainVotingExecutor = void 0;
    class OSWAP_SideChainVotingExecutor extends eth_contract_14.Contract {
        constructor(wallet, address) {
...
define("@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_VotingContract.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_VotingContract.json.ts"], function (require, exports, eth_contract_15, OSWAP_VotingContract_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.OSWAP_VotingContract = void 0;
    class OSWAP_VotingContract extends eth_contract_15.Contract {
        constructor(wallet, address) {
        ...
        assign() {
            ...
            let allOptionsWeight_call = async (options) => {
                ...
                return result.map(e => new eth_contract_15.BigNumber(e));
            };
            ...
            let getParams_call = async (options) => {
                ...
                return {
                    ...
                    id: new eth_contract_15.BigNumber(result.id_),
                    name: result.name_,
                    options: result.options_,
                    voteStartTime: new eth_contract_15.BigNumber(result.voteStartTime_),
                    voteEndTime: new eth_contract_15.BigNumber(result.voteEndTime_),
                    executeDelay: new eth_contract_15.BigNumber(result.executeDelay_),
                    status: result.status_,
                    optionsWeight: result.optionsWeight_.map(e => new eth_contract_15.BigNumber(e)),
                    quorum: result.quorum_.map(e => new eth_contract_15.BigNumber(e)),
...
define("@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_VotingManager.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_VotingManager.json.ts"], function (require, exports, eth_contract_16, OSWAP_VotingManager_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.OSWAP_VotingManager = void 0;
    class OSWAP_VotingManager extends eth_contract_16.Contract {
        constructor(wallet, address) {
        ...
        decodeAddVotingConfigEvent(event) {
            ...
            return {
                name: result.name,
                minExeDelay: new eth_contract_16.BigNumber(result.minExeDelay),
                minVoteDuration: new eth_contract_16.BigNumber(result.minVoteDuration),
                maxVoteDuration: new eth_contract_16.BigNumber(result.maxVoteDuration),
                minGovTokenToCreateVote: new eth_contract_16.BigNumber(result.minGovTokenToCreateVote),
                minQuorum: new eth_contract_16.BigNumber(result.minQuorum),
                _event: event
            };
        }
        parseAuthorizeEvent(receipt) {
        ...
        decodePollEvent(event) {
            ...
            return {
                account: result.account,
                poll: result.poll,
                option: new eth_contract_16.BigNumber(result.option),
                _event: event
            };
        }
        ...
        assign() {
            ...
            let getVotingParams_call = async (name, options) => {
                ...
                return {
                    minExeDelay: new eth_contract_16.BigNumber(result._minExeDelay),
                    minVoteDuration: new eth_contract_16.BigNumber(result._minVoteDuration),
                    maxVoteDuration: new eth_contract_16.BigNumber(result._maxVoteDuration),
                    minGovTokenToCreateVote: new eth_contract_16.BigNumber(result._minGovTokenToCreateVote),
                    minQuorum: new eth_contract_16.BigNumber(result._minQuorum)
                };
            };
...
define("@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_VotingRegistry.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_VotingRegistry.json.ts"], function (require, exports, eth_contract_17, OSWAP_VotingRegistry_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.OSWAP_VotingRegistry = void 0;
    class OSWAP_VotingRegistry extends eth_contract_17.Contract {
        constructor(wallet, address) {
...
define("@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_BridgeVault.ts", ["require", "exports", "@ijstech/eth-contract", "@scom/oswap-cross-chain-bridge-contract/contracts/OSWAP_BridgeVault.json.ts"], function (require, exports, eth_contract_18, OSWAP_BridgeVault_json_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.OSWAP_BridgeVault = void 0;
    class OSWAP_BridgeVault extends eth_contract_18.Contract {
        constructor(wallet, address) {
        ...
        decodeAddLiquidityEvent(event) {
            ...
            return {
                ...
                amount: new eth_contract_18.BigNumber(result.amount),
                mintAmount: new eth_contract_18.BigNumber(result.mintAmount),
                newBalance: new eth_contract_18.BigNumber(result.newBalance),
                newLpAssetBalance: new eth_contract_18.BigNumber(result.newLpAssetBalance),
                _event: event
            };
        }
        ...
        decodeAmendOrderRequestEvent(event) {
            let result = event.data;
            return {
                orderId: new eth_contract_18.BigNumber(result.orderId),
                amendment: new eth_contract_18.BigNumber(result.amendment),
                order: {
                    peerChain: new eth_contract_18.BigNumber(result.order.peerChain),
                    inAmount: new eth_contract_18.BigNumber(result.order.inAmount),
                    outToken: result.order.outToken,
                    minOutAmount: new eth_contract_18.BigNumber(result.order.minOutAmount),
                    to: result.order.to,
                    expire: new eth_contract_18.BigNumber(result.order.expire)
                },
                _event: event
            };
        }
        ...
        decodeApprovalEvent(event) {
            ...
            return {
                owner: result.owner,
                spender: result.spender,
                value: new eth_contract_18.BigNumber(result.value),
                _event: event
            };
        }
        ...
        decodeNewOrderEvent(event) {
            ...
            return {
                ...
                newImbalance: new eth_contract_18.BigNumber(result.newImbalance),
                _event: event
            };
        }
        ...
        decodeOrderCanceledEvent(event) {
            ...
            return {
                orderId: new eth_contract_18.BigNumber(result.orderId),
                sender: result.sender,
                signers: result.signers.map(e => new eth_contract_18.BigNumber(e)),
                canceledByOrderOwner: result.canceledByOrderOwner,
                newImbalance: new eth_contract_18.BigNumber(result.newImbalance),
                newProtocolFeeBalance: new eth_contract_18.BigNumber(result.newProtocolFeeBalance),
                _event: event
            };
        }
        ...
        decodeRemoveLiquidityEvent(event) {
            ...
            return {
                provider: result.provider,
                amount: new eth_contract_18.BigNumber(result.amount),
                newPendingWithdrawal: new eth_contract_18.BigNumber(result.newPendingWithdrawal),
                _event: event
            };
        }
        ...
        decodeRemoveLiquidityRequestEvent(event) {
            ...
            return {
                provider: result.provider,
                amount: new eth_contract_18.BigNumber(result.amount),
                burnAmount: new eth_contract_18.BigNumber(result.burnAmount),
                newBalance: new eth_contract_18.BigNumber(result.newBalance),
                newLpAssetBalance: new eth_contract_18.BigNumber(result.newLpAssetBalance),
                newPendingWithdrawal: new eth_contract_18.BigNumber(result.newPendingWithdrawal),
                _event: event
        ...
        decodeRequestCancelOrderEvent(event) {
            ...
            return {
                owner: result.owner,
                sourceChainId: new eth_contract_18.BigNumber(result.sourceChainId),
                orderId: new eth_contract_18.BigNumber(result.orderId),
        ...
        decodeSwapEvent(event) {
            ...
            return {
                ...
                outAmount: new eth_contract_18.BigNumber(result.outAmount),
                newImbalance: new eth_contract_18.BigNumber(result.newImbalance),
                newLpAssetBalance: new eth_contract_18.BigNumber(result.newLpAssetBalance),
                newProtocolFeeBalance: new eth_contract_18.BigNumber(result.newProtocolFeeBalance),
                _event: event
        ...
        decodeSyncEvent(event) {
            let result = event.data;
            return {
                excess: new eth_contract_18.BigNumber(result.excess),
                newProtocolFeeBalance: new eth_contract_18.BigNumber(result.newProtocolFeeBalance),
                _event: event
            };
        }
        ...
        assign() {
            ...
            let getOrders_call = async (params, options) => {
                ...
                return (result.map(e => ({
                    peerChain: new eth_contract_18.BigNumber(e.peerChain),
                    inAmount: new eth_contract_18.BigNumber(e.inAmount),
                    outToken: e.outToken,
                    minOutAmount: new eth_contract_18.BigNumber(e.minOutAmount),
                    to: e.to,
                    expire: new eth_contract_18.BigNumber(e.expire)
                })));
            };
            ...
            let orderAmendments_call = async (params, options) => {
                ...
                return {
                    peerChain: new eth_contract_18.BigNumber(result.peerChain),
                    inAmount: new eth_contract_18.BigNumber(result.inAmount),
                    outToken: result.outToken,
                    minOutAmount: new eth_contract_18.BigNumber(result.minOutAmount),
                    to: result.to,
                    expire: new eth_contract_18.BigNumber(result.expire)
                };
            };
